...
zipdir("./src", { saveTo: "./build/extension.zip" }, function (err, buffer) {
	...
	fs.copyFile("./build/extension.zip", "./build/extension.crx", (err) => {
		...
		log("IMPORTANT: IF YOU ARE MAKING AN OFFICIAL EXTENSION RELEASE, THEN PLEASE REMEMBER TO SIGN THE .CRX WITH A PRIVATE KEY FILE.\n");
	});
